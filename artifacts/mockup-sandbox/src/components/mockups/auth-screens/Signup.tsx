        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex gap-1">
              {["bg-red-500","bg-orange-500","bg-white/10"].map((c,i) => (
          ...
          {/* CTA */}
          <button className="w-full bg-[#a855f7] text-white font-bold rounded-xl py-4 flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(168,85,247,0.35)] active:scale-[0.98] transition-all">
          ...
          <div className="w-full bg-[#a855f7]/5 border border-[#a855f7]/20 rounded-xl p-3 text-[10px] text-white/40 leading-relaxed">
            <span className="text-[#a855f7] font-bold">UX:</span> Progress bar = sense of completion. Inline password strength = instant feedback. "Continue" not "Sign up" = lower commitment. Terms checkbox is prominent.
          </div>
        </div>
      </div>
    </div>
