...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#08080e] flex flex-col items-center justify-between p-6 font-['Inter']">
      {/* Status bar */}
      ...
      <div className="w-full flex flex-col gap-4 mt-8">
        <div className="flex flex-col gap-1.5">
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl px-4 py-3.5 text-sm text-white/40 flex items-center">
        ...
        {/* Primary CTA */}
        <button className="w-full bg-[#a855f7] text-white font-bold rounded-xl py-4 flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(168,85,247,0.4)] mt-2 active:scale-[0.98] transition-all">
      ...
      {/* Footer */}
      <p className="text-white/30 text-sm mt-6 mb-4">
      ...
      <div className="w-full bg-[#a855f7]/5 border border-[#a855f7]/20 rounded-xl p-3 text-[10px] text-white/40 leading-relaxed">
        <span className="text-[#a855f7] font-bold">UX:</span> Single-purpose screen — email + password + 2 social options. "Forgot?" inline with label = 1 tap. Neon CTA = highest visual weight. No logo clutter.
      </div>
    </div>
  );
}
